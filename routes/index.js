...
const {
    ...
    updateindemnizacion,
    deleteindemnizacion
} = require("../controllers/indemnizacion");
...
//Vehiculo CRUD
router.get('/indemnizacion', getAllindemnizacion)
router.get('/indemnizacion/:ind_id', getindemnizacionById)
router.post('/indemnizacion', createindemnizacion)
router.put("/indemnizacion/:ind_id", updateindemnizacion)
router.delete('/indemnizacion/:ind_id', deleteindemnizacion)
...
router.get('/getTour/:id', getTourById)
